...
// Ponto único de abertura: todas as ferramentas (advplc, adveditor,
// advpp-ide) devem usar esta função para enxergar o mesmo banco com o
// mesmo comportamento.
//
...
// banco local visível (para adveditor no mesmo diretório enxergar) mesmo
// que nenhuma tabela tenha sido criada ainda.
